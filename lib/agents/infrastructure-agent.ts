...
import { InfrastructureSchema, type InfrastructureOutput, OrchestratorOutput } from "./schemas";
import { INFRASTRUCTURE_SYSTEM_PROMPT } from "./system-prompts";
import type { AgentOptions } from "./geopolitics-agent";

export async function runInfrastructureAgent(
  orchestratorOutput: OrchestratorOutput,
  gdeltContext: string,
  options: AgentOptions = {}
): Promise<{ narrative: string; structured: InfrastructureOutput }> {
