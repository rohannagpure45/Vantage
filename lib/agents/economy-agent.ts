...
import { EconomySchema, type EconomyOutput, OrchestratorOutput } from "./schemas";
import { ECONOMY_SYSTEM_PROMPT } from "./system-prompts";
import type { AgentOptions } from "./geopolitics-agent";

export async function runEconomyAgent(
  orchestratorOutput: OrchestratorOutput,
  gdeltContext: string,
  options: AgentOptions = {}
): Promise<{ narrative: string; structured: EconomyOutput }> {
